...
const SearchBar = ({
    ...
    const [showContent, setShowContent] = useState(alwaysOpen);
                    ...
                    {showContent && (
                        <motion.div
                            ...
                            style={{
                                ...
                                alignItems: 'center',
                                height: '100%',
                                overflow: 'visible', // Allow icons to pop
                                gap: '1rem' // Match original variant gap
                            }}
